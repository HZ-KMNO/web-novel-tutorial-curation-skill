...
- Read [references/excellent-novel-case-batch-2026-06-10.md](references/excellent-novel-case-batch-2026-06-10.md) when curating the 2026-06-10 additions from `E:\小说编写相关\优秀小说案例`, especially traditional Chinese story boxes, 古龙-style character entrances, 三言二拍-style social pressure, 封神-style faction/artifact/list engines, and translated adventure classics.
- Read [references/hama-zhihu-answer-index.md](references/hama-zhihu-answer-index.md) when curating 流浪的蛤蟆's Zhihu writing answers, especially for classic reading, story boxes, satisfaction mechanics, combat setup, long-form planning, market/platform sense, revision practice, and beginner diagnostics.
- Read [references/qidianclub-author-advice-index-2026-06-09.md](references/qidianclub-author-advice-index-2026-06-09.md) when curating QidianClub-style author interviews, 名家经验谈, 白金作家访谈, 龙空精华帖, or top-author writing-advice index pages similar to the 流浪的蛤蟆 source workflow.
- Read [references/bilibili-author-tutorial-batch-2026-06-13.md](references/bilibili-author-tutorial-batch-2026-06-13.md) when processing newly imported Bilibili author tutorial DOCX transcripts about 流浪的蛤蟆's market/outlining/opening advice, golden three chapters, sensory description, BE emotion, combat scenes, or AI de-flavoring.
