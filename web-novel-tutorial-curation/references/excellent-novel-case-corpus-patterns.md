# Excellent Novel Case Corpus Patterns
...
| 许三观卖血记 | 余华 | zh | 278103 | repeated survival transaction motif | tragicomic repetition, body-as-currency stakes, family pressure |
| 野草 | 鲁迅 | zh-CN | 4434340 | symbolic prose fragments and psychological compression | motif clusters, compressed dread, image-driven emotional pressure |
...
- copying famous trick solutions
- making clues impossible to infer
- solving mysteries through sudden new information
- using detective structure without emotional stakes
...
- The batch count is explicit.
- Non-fiction sources are labeled as structure/worldbuilding sources.
- Each case has a concrete fiction-writing use.
- No long source text is stored.
- The output helps planning, drafting, revision, or de-AI polishing.

Failure signs:

- The file becomes a reading journal instead of a writing-method reference.
